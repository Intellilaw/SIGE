...
const envSchema = z.object({
  ...
  GOOGLE_WORKSPACE_OAUTH_REDIRECT_URI: z.preprocess((value) => value === "" ? undefined : value, z.string().url().optional()),
  GOOGLE_WORKSPACE_TOKEN_ENCRYPTION_SECRET: z.preprocess((value) => value === "" ? undefined : value, z.string().min(32).optional())
});
