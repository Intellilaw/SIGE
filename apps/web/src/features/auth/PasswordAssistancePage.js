...
export function PasswordAssistancePage() {
    ...
    return (_jsx("main", { className: "login-page", children: _jsxs("section", { className: "login-card auth-support-card", children: [_jsx("p", { className: "eyebrow", children: "Onboarding seguro" }), _jsx("h1", { children: "Activar o restablecer contrasena" }), _jsx("p", { className: "muted", children: "Si tu cuenta fue migrada desde Intranet o perdiste acceso, escribe tu usuario o correo. En ambiente local, SIGE_2 mostrara un enlace de vista previa para completar el proceso sin exponer contrasenas legacy." }), _jsx("p", { className: "login-back-link", children: _jsx(Link, { to: "/intranet-login", children: "Volver al acceso RC" }) }), _jsxs("form", { className: "login-form", onSubmit: handleSubmit, children: [_jsxs("label", { children: ["Usuario o email", _jsx("input", { value: identifier, onChange: (event) => setIdentifier(event.target.value), placeholder: "ej. alejandra.mejia o alejandra.mejia@calculadora.app", type: "text" })] }), error ? _jsx("p", { className: "error-text", children: error }) : null, _jsx("button", { type: "submit", children: isSubmitting ? "Generando..." : "Solicitar enlace seguro" })] }), result ? (_jsxs("div", { className: "auth-support-result", children: [_jsx("div", { className: "message-banner message-success", children: result.message }), result.deliveryMode === "development-preview" && result.resetUrl ? (_jsxs("div", { className: "link-preview-card", children: [_jsx("p", { className: "eyebrow", children: "Vista previa local" }), _jsx("h2", { children: "Enlace listo para usar" }), _jsx("p", { className: "muted", children: "Este enlace solo aparece fuera de produccion. En despliegue real se enviara por el canal de onboarding definido." }), _jsx("a", { className: "preview-link", href: result.resetUrl, children: "Abrir flujo de activacion" }), _jsx("code", { children: result.resetUrl }), formatExpiry(result.expiresAt) ? (_jsxs("p", { className: "muted", children: ["Expira: ", formatExpiry(result.expiresAt)] })) : null] })) : null] })) : null] }) }));
}
