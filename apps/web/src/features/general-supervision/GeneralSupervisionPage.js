...
function TaskOverviewPanel({ overview }) {
    return (_jsxs("article", { className: "supervision-task-overview", children: [_jsxs("header", { className: "supervision-task-overview-head", children: [_jsxs("div", { className: "supervision-task-stat is-total", children: [_jsx("span", { children: "Total critico" }), _jsx("strong", { children: overview.total })] }), _jsxs("div", { className: "supervision-task-stat is-today", children: [_jsx("span", { children: "Para hoy" }), _jsx("strong", { children: overview.todayTotal })] }), _jsxs("div", { className: "supervision-task-stat is-overdue", children: [_jsx("span", { children: "Vencidas / sin fecha" }), _jsx("strong", { children: overview.overdueTotal })] })] }), _jsx("div", { className: "supervision-task-user-list", children: overview.users.length === 0 ? (_jsx(EmptyState, { children: "Sin tareas urgentes por usuario." })) : (overview.users.map((user) => (_jsxs("section", { className: "supervision-task-user-row", children: [_jsxs("div", { className: "supervision-task-user-main", children: [_jsx("h4", { children: user.displayName }), _jsx("span", { children: user.shortName ?? user.teamLabel })] }), _jsxs("div", { className: "supervision-task-counts", "aria-label": `${user.displayName}: ${formatTaskCount(user.total)} criticas, ${formatTaskCount(user.today)} para hoy y ${formatTaskCount(user.overdue)} vencidas`, children: [_jsxs("span", { className: "is-total", children: [_jsx("strong", { children: user.total }), "Total"] }), _jsxs("span", { children: [_jsx("strong", { children: user.today }), "Hoy"] }), _jsxs("span", { className: "is-overdue", children: [_jsx("strong", { children: user.overdue }), "Vencidas"] })] }), _jsx("div", { className: "supervision-task-link-list", children: user.dashboardLinks.map((link) => (_jsx(Link, { className: "secondary-button supervision-task-dashboard-link", to: link.path, children: user.dashboardLinks.length === 1 ? "Ir al dashboard" : link.label }, link.moduleId))) })] }, user.userId)))) })] }));
}
