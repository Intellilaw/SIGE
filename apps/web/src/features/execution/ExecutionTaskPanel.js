...
import { CREATE_TASKS_RI_CONNECTION_ID, findDuplicateTaskMatch } from "./execution-task-intelligence";
...
export function ExecutionTaskPanel({ module, legacyConfig, distributionEvents, matter, submatter, clientNumber, mode, tasks, onClose, onModeChange, onCreateTask, onUpdateState }) {
    ...
    function handleClearTargetName(targetId) {
        setSelectorTargets((current) => current.map((candidate) => (candidate.id === targetId ? { ...candidate, taskName: "" } : candidate)));
        setSuccessMessage(null);
    }
    if (!matter || !mode) {
        return null;
    ...
    return (_jsx("div", { className: "execution-panel-backdrop", role: "presentation", onClick: onClose, children: _jsxs("aside", { className: `execution-panel ${mode === "create" ? "execution-panel-selector" : ""}`, role: "dialog", "aria-modal": "true", "aria-label": mode === "create" ? "Crear tareas" : "Lista de tareas", onClick: (event) => event.stopPropagation(), children: [_jsxs("div", { className: "execution-panel-header", children: [_jsxs("div", { children: [_jsxs("p", { className: "eyebrow", children: ["Ejecucion / ", module.shortLabel] }), _jsx("h3", { children: mode === "create" ? "Crear tareas" : "Lista de tareas" }), _jsxs("p", { className: "muted execution-panel-copy", children: [matter.clientName || "Cliente sin nombre", " - ", matter.subject || "Asunto sin nombre"] }), activeSubmatter ? (_jsxs("p", { className: "muted execution-panel-copy execution-panel-submatter-copy", children: ["Subfila: ", activeSubmatterLabel || "Subasunto sin nombre"] })) : null, mode === "create" ? (_jsx("div", { className: "execution-panel-ri-anchor", children: _jsx(RusconiIntelligenceBadge, { connectionId: CREATE_TASKS_RI_CONNECTION_ID, label: "Ejecucion / Crear tareas" }) })) : null] }), _jsx("button", { type: "button", className: "secondary-button", onClick: onClose, children: "Cerrar" })] }), mode === "history" ? (_jsx("div", { className: "execution-panel-switcher", children: _jsx("button", { type: "button", className: "secondary-button", onClick: () => onModeChange("create"), children: "Crear tareas" }) })) : null, mode === "create" ? (_jsx("div", { className: "execution-panel-body execution-panel-form", children: _jsxs("div", { className: "execution-selector-layout", children: [_jsxs("div", { className: "execution-selector-form", children: [_jsxs("label", { className: "form-field execution-selector-search-field", children: [_jsx("span", { children: "Seleccionar tarea" }), _jsxs("div", { className: "execution-selector-search", ref: searchWrapRef, children: [_jsx("input", { value: taskSearch, onChange: (event) => {
                                                            ...
                                                            if (selectedEventId) {
                                                                ...
                                                                : " Si necesitas registrarla de todas formas, presiona Distribuir Tareas para confirmar la excepcion."] })] })] })) : null, successMessage ? (_jsx("div", { className: "message-banner message-success", children: successMessage })) : null, _jsxs("div", { className: "execution-selector-matter", children: [_jsx("h4", { children: "Detalles del Asunto (Lectura)" }), _jsxs("div", { className: "execution-selector-matter-grid", children: [_jsxs("label", { className: "form-field", children: [_jsx("span", { children: "ID Asunto" }), _jsx("input", { readOnly: true, value: activeMatter.matterIdentifier || activeMatter.matterNumber || "" })] }), activeSubmatter ? (_jsxs("label", { className: "form-field", children: [_jsx("span", { children: "ID subfila" }), _jsx("input", { readOnly: true, value: activeSubmatter.matterIdentifier || "" })] })) : null, _jsxs("label", { className: "form-field", children: [_jsx("span", { children: "No. Cliente" }), _jsx("input", { readOnly: true, value: clientNumber || activeMatter.clientNumber || "" })] }), _jsxs("label", { className: "form-field execution-selector-span", children: [_jsx("span", { children: "Cliente" }), _jsx("input", { readOnly: true, value: activeMatter.clientName || "" })] }), _jsxs("label", { className: "form-field execution-selector-span", children: [_jsx("span", { children: "Asunto / Expediente" }), _jsx("input", { readOnly: true, value: activeMatter.subject || "" })] }), _jsxs("label", { className: "form-field execution-selector-span", children: [_jsx("span", { children: "Proceso espec\u00EDfico" }), _jsx("input", { readOnly: true, value: activeSubmatter?.specificProcess || activeMatter.specificProcess || "" })] })] })] })] }), _jsxs("div", { className: "execution-selector-summary", children: [_jsx("h3", { children: "Resumen de Env\u00EDo" }), selectorTargets.length === 0 ? (_jsx("div", { className: "centered-inline-message", children: "Selecciona una tarea para ver las tablas destino." })) : (_jsx("div", { className: "execution-selector-target-list", children: selectorTargets.map((target) => (_jsxs("article", { className: "execution-selector-target-card", children: [_jsxs("div", { className: "tasks-distributor-target-head", children: [_jsx("strong", { children: getTableDisplayName(legacyConfig, target.tableSlug) }), _jsx("button", { type: "button", className: "danger-button tasks-distributor-small-button", onClick: () => setSelectorTargets((current) => current.filter((candidate) => candidate.id !== target.id)), children: "Quitar" })] }), _jsxs("div", { className: "execution-selector-target-name-row", children: [_jsx("input", { value: target.taskName, onChange: (event) => setSelectorTargets((current) => current.map((candidate) => candidate.id === target.id ? { ...candidate, taskName: event.target.value } : candidate)), placeholder: "Nombre del registro", "aria-label": `Nombre del registro para ${getTableDisplayName(legacyConfig, target.tableSlug)}` }), _jsx("button", { type: "button", className: "secondary-button execution-selector-clear-button", onClick: () => handleClearTargetName(target.id), disabled: !target.taskName, "aria-label": `Borrar texto de ${getTableDisplayName(legacyConfig, target.tableSlug)}`, title: "Borrar texto", children: "Limpiar" })] }), legacyConfig.tables.find((table) => table.slug === target.tableSlug)?.showReportedPeriod ? (_jsxs("label", { className: "form-field", children: [_jsx("span", { children: legacyConfig.tables.find((table) => table.slug === target.tableSlug)?.reportedPeriodLabel ?? "Periodo reportado" }), _jsx("input", { type: "month", value: target.reportedMonth, onChange: (event) => setSelectorTargets((current) => current.map((candidate) => candidate.id === target.id ? { ...candidate, reportedMonth: event.target.value } : candidate)) })] })) : null] }, target.id))) }))] })] }) })) : (_jsx("div", { className: "execution-panel-body", children: tasks.length === 0 ? (_jsx("div", { className: "centered-inline-message", children: "No hay tareas ligadas a este asunto." })) : (_jsx("div", { className: "execution-task-list", children: tasks.map((task) => (_jsxs("article", { className: "execution-task-card", children: [_jsxs("div", { className: "execution-task-topline", children: [_jsxs("div", { children: [_jsx("strong", { children: task.subject }), _jsxs("p", { className: "muted execution-task-meta", children: [task.trackLabel, " - ", task.responsible || "Sin responsable", " - ", toDateInput(task.dueDate) || "-"] }), task.executionSubmatterLabel ? (_jsxs("p", { className: "muted execution-task-meta", children: ["Subfila: ", task.executionSubmatterLabel] })) : null] }), _jsx("span", { className: `execution-task-state execution-task-state-${task.state.toLowerCase()}`, children: getStateLabel(task.state) })] }), task.isMatterFallback ? (_jsx("p", { className: "muted execution-task-meta", children: "Esta fila viene del origen del asunto. Para gestionarla desde Ejecucion, crea una tarea en Crear tareas." })) : (_jsx("div", { className: "execution-task-actions", children: ["PENDING", "IN_PROGRESS", "COMPLETED"].map((state) => (_jsx("button", { type: "button", className: task.state === state ? "primary-button" : "secondary-button", disabled: savingTaskId === task.id, onClick: () => void handleStateChange(task, state), children: state === "PENDING" ? "Pendiente" : state === "IN_PROGRESS" ? "En curso" : "Completar" }, state))) }))] }, task.id))) })) }))] }) }));
}
