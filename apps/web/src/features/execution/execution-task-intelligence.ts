...
export type DuplicateTaskMatch = {
...
export type DuplicateTaskTarget = {
  taskName: string;
};

export type DuplicateTaskRecord = {
  subject?: string | null;
...
function getCandidateTaskNames(
  selectedEvent: TaskDistributionEvent | null | undefined,
  targets: DuplicateTaskTarget[]
) {
...
function isActiveDuplicateCandidate(task: DuplicateTaskRecord) {
...
export function findDuplicateTaskMatch(
  selectedEvent: TaskDistributionEvent | null | undefined,
  targets: DuplicateTaskTarget[],
  tasks: DuplicateTaskRecord[]
