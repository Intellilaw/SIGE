...
function MatterTable({ items, loading, quotes, clients, reflections, commissionOptions, selectedIds, rowRefs, readOnly, variant, canDeleteReadOnlyRows, onToggleSelection, onToggleAll, onClientChange, onLocalChange, onImmediateChange, onQuoteChange, onBlur, onGenerateIdentifier, onSendToExecution, onTrash }) {
