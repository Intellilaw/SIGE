...
export function LeadsPage() {
    ...
    const sentMonthlyTotal = useMemo(() => monthlyItems.reduce((sum, item) => sum + Number(item.amountMxn || 0), 0), [monthlyItems]);
    const contractedMonthlyTotal = useMemo(() => monthlyItems.reduce((sum, item) => sum + (item.status === "MOVED_TO_MATTERS" ? Number(item.amountMxn || 0) : 0), 0), [monthlyItems]);
    ...
    return (_jsxs("section", { className: "page-stack leads-page", children: [_jsxs("header", { className: "hero module-hero", children: [_jsxs("div", { className: "module-hero-head", children: [_jsx("span", { className: "module-hero-icon", "aria-hidden": "true", children: "Leads" }), _jsx("div", { children: _jsx("h2", { children: "Seguimiento a Leads y Cotizaciones" }) })] }), _jsx("p", { className: "muted", children: "Replica funcional del tablero de Intranet: seguimiento diario, historial de conversion a asuntos y vista mensual de cotizaciones enviadas." })] }), _jsx("section", { className: "panel", children: _jsxs("div", { className: "leads-tabs", role: "tablist", "aria-label": "Vistas de leads", children: [_jsx("button", { type: "button", className: `lead-tab ${activeTab === "leads" ? "is-active" : ""}`, onClick: () => setActiveTab("leads"), children: "1. Leads Activos y Diario" }), _jsx("button", { type: "button", className: `lead-tab ${activeTab === "month" ? "is-active" : ""}`, onClick: () => setActiveTab("month"), children: "2. Vista Mensual de Cotizaciones" })] }) }), errorMessage ? _jsx("div", { className: "message-banner message-error", children: errorMessage }) : null, activeTab === "leads" ? (_jsxs(_Fragment, { children: [_jsxs("section", { className: "panel", children: [_jsxs("div", { className: "panel-header", children: [_jsx("h2", { children: "1. Leads Activos" }), _jsxs("span", { children: [activeItems.length, " registros"] })] }), _jsxs("div", { className: "lead-toolbar", children: [_jsxs("div", { className: "lead-toolbar-actions", children: [_jsx("button", { type: "button", className: "primary-button", onClick: () => void handleAddRow(), children: "+ Agregar Fila" }), selectedLeads.size > 0 ? (_jsxs("button", { type: "button", className: "danger-button", onClick: () => void handleBulkDelete(), children: ["Borrar (", selectedLeads.size, ")"] })) : null] }), _jsx("button", { type: "button", className: "secondary-button", onClick: () => void loadBoard(), children: "Refrescar" })] }), _jsx("div", { className: "lead-table-shell", children: _jsx("div", { className: "lead-table-wrapper", children: _jsxs("table", { className: "lead-table lead-table-active", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { className: "lead-table-checkbox", children: _jsx("input", { type: "checkbox", checked: activeItems.length > 0 && selectedLeads.size === activeItems.length, onChange: (event) => {
                                                                    if (event.target.checked) {
                                                                        setSelectedLeads(new Set(activeItems.map((item) => item.id)));
                                                                        return;
                                                                    }
                                                                    setSelectedLeads(new Set());
                                                                } }) }), _jsx("th", { children: "Comision cierre" }), _jsx("th", { children: "Cliente" }), _jsx("th", { children: "Prospecto" }), _jsx("th", { children: "No. Cotizacion" }), _jsx("th", { children: "Tipo" }), _jsx("th", { children: "Asunto" }), _jsx("th", { children: "Total" }), _jsx("th", { children: "Canal" }), _jsx("th", { children: "Ultima" }), _jsx("th", { children: "Fecha" }), _jsx("th", { children: "Siguiente" }), _jsx("th", { children: "Fecha" }), _jsx("th", { children: "Notas" }), _jsx("th", { children: "Accion" }), _jsx("th", { children: "Borrar" })] }) }), _jsx("tbody", { children: loading ? (_jsx("tr", { children: _jsx("td", { colSpan: 16, className: "centered-inline-message", children: "Cargando leads..." }) })) : activeItems.length === 0 ? (_jsx("tr", { children: _jsx("td", { colSpan: 16, className: "centered-inline-message", children: "No hay leads activos." }) })) : (activeItems.map((item) => {
                                                ...
                                                })) })] }) }) })] }), _jsxs("section", { className: "panel", children: [_jsxs("div", { className: "panel-header", children: [_jsx("h2", { children: "2. Historial (Enviados a Asuntos Activos)" }), _jsxs("span", { children: [historyItems.length, " registros"] })] }), _jsx("p", { className: "muted lead-panel-copy", children: "Los registros enviados se ocultan automaticamente despues de 30 dias, igual que en la referencia." }), _jsx("div", { className: "lead-table-shell", children: _jsx("div", { className: "lead-table-wrapper", children: _jsxs("table", { className: "lead-table lead-table-history", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "Comision cierre" }), _jsx("th", { children: "Cliente" }), _jsx("th", { children: "Prospecto" }), _jsx("th", { children: "No. Cotizacion" }), _jsx("th", { children: "Tipo" }), _jsx("th", { children: "Asunto" }), _jsx("th", { children: "Total" }), _jsx("th", { children: "Canal" }), _jsx("th", { children: "Ultima interaccion" }), _jsx("th", { children: "Fecha de envio" }), _jsx("th", { children: "Notas" }), _jsx("th", { children: "Accion" }), _jsx("th", { children: "Borrar" })] }) }), _jsx("tbody", { children: loading ? (_jsx("tr", { children: _jsx("td", { colSpan: 13, className: "centered-inline-message", children: "Cargando historial..." }) })) : historyItems.length === 0 ? (_jsx("tr", { children: _jsx("td", { colSpan: 13, className: "centered-inline-message", children: "No hay historial reciente." }) })) : (historyItems.map((item) => {
                                                    const linkedQuote = findQuoteByNumber(item.quoteNumber);
                                                ...
                                                })) })] }) }) })] })] })) : (_jsxs(_Fragment, { children: [_jsxs("section", { className: "panel lead-month-toolbar", children: [_jsxs("div", { className: "lead-month-filters", children: [_jsxs("label", { className: "form-field", children: [_jsx("span", { children: "Ano" }), _jsx("select", { value: selectedYear, onChange: (event) => setSelectedYear(Number(event.target.value)), children: selectedYearOptions.map((year) => (_jsx("option", { value: year, children: year }, year))) })] }), _jsxs("label", { className: "form-field", children: [_jsx("span", { children: "Mes" }), _jsx("select", { value: selectedMonth, onChange: (event) => setSelectedMonth(Number(event.target.value)), children: MONTH_NAMES.map((monthName, index) => (_jsx("option", { value: index + 1, children: monthName }, monthName))) })] })] }), _jsxs("div", { className: "lead-summary-grid", children: [_jsxs("article", { className: "lead-summary-card is-sent", children: [_jsx("span", { children: "Total Enviado (Mes)" }), _jsx("strong", { children: formatCurrency(sentMonthlyTotal) })] }), _jsxs("article", { className: "lead-summary-card is-contracted", children: [_jsx("span", { children: "Total Contratadas (Mes)" }), _jsx("strong", { children: formatCurrency(contractedMonthlyTotal) })] })] })] }), _jsxs("section", { className: "panel", children: [_jsxs("div", { className: "panel-header", children: [_jsxs("h2", { children: ["Cotizaciones enviadas en ", MONTH_NAMES[selectedMonth - 1]] }), _jsxs("span", { children: [monthlyItems.length, " registros"] })] }), _jsx("div", { className: "lead-table-shell", children: _jsx("div", { className: "lead-table-wrapper", children: _jsxs("table", { className: "lead-table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "Comision cierre" }), _jsx("th", { children: "Cliente" }), _jsx("th", { children: "No. Cotizacion" }), _jsx("th", { children: "Asunto" }), _jsx("th", { children: "Total" }), _jsx("th", { children: "Fecha de envio" }), _jsx("th", { children: "Estatus" }), _jsx("th", { children: "Borrar" })] }) }), _jsx("tbody", { children: loading ? (_jsx("tr", { children: _jsx("td", { colSpan: 8, className: "centered-inline-message", children: "Cargando vista mensual..." }) })) : monthlyItems.length === 0 ? (_jsx("tr", { children: _jsx("td", { colSpan: 8, className: "centered-inline-message", children: "No hay cotizaciones enviadas este mes." }) })) : (monthlyItems.map((item) => (_jsxs("tr", { className: item.status === "MOVED_TO_MATTERS" ? "lead-row-contracted" : "", children: [_jsx("td", { children: item.commissionAssignee || "-" }), _jsx("td", { children: item.clientName || item.prospectName || "-" }), _jsx("td", { className: "lead-table-emphasis", children: item.quoteNumber || "-" }), _jsx("td", { children: item.subject || "-" }), _jsx("td", { children: formatCurrency(Number(item.amountMxn || 0)) }), _jsx("td", { children: formatDate(item.sentToClientAt) }), _jsx("td", { children: _jsx("span", { className: `lead-status-pill ${item.status === "MOVED_TO_MATTERS" ? "is-success" : "is-pending"}`, children: item.status === "MOVED_TO_MATTERS" ? "Contratada" : "Pendiente / Activa" }) }), _jsx("td", { children: _jsx("button", { type: "button", className: "danger-button lead-delete-button", onClick: () => void handleDelete(item.id), children: "Borrar" }) })] }, item.id)))) })] }) }) })] })] }))] }));
}
