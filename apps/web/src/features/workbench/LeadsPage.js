...
export function LeadsPage() {
    ...
    async function loadBoard() {
        ...
        try {
            const [activeRows, historyRows, quoteRows, shortNames] = await Promise.all([
                ...
                canWriteLeads ? apiGet("/quotes") : Promise.resolve([]),
    ...
    return (_jsxs("section", { className: "page-stack leads-page", children: [_jsxs("header", { className: "hero module-hero", children: [_jsxs("div", { className: "module-hero-head", children: [_jsx("span", { className: "module-hero-icon", "aria-hidden": "true", children: "Leads" }), _jsx("div", { children: _jsx("h2", { children: "Seguimiento a Leads y Cotizaciones" }) })] }), _jsx("p", { className: "muted", children: "Seguimiento diario de leads, historial de conversion a asuntos y vista mensual de cotizaciones enviadas." })] }), _jsx("section", { className: "panel", children: _jsxs("div", { className: "leads-tabs", role: "tablist", "aria-label": "Vistas de leads", children: [_jsx("button", { type: "button", className: `lead-tab ${activeTab === "leads" ? "is-active" : ""}`, onClick: () => setActiveTab("leads"), children: "1. Leads Activos y Diario" }), _jsx("button", { type: "button", className: `lead-tab ${activeTab === "month" ? "is-active" : ""}`, onClick: () => setActiveTab("month"), children: "2. Vista Mensual de Cotizaciones" })] }) }), errorMessage ? _jsx("div", { className: "message-banner message-error", children: errorMessage }) : null, activeTab === "leads" ? (_jsxs(_Fragment, { children: [_jsxs("section", { className: "panel", children: [_jsxs("div", { className: "panel-header", children: [_jsx("h2", { children: "1. Leads Activos" }), _jsxs("span", { children: [filteredActiveItems.length, " registros"] })] }), _jsxs("div", { className: "matters-toolbar matters-active-toolbar", children: [_jsxs("div", { className: "matters-toolbar-actions", children: [canWriteLeads ? (_jsx("button", { type: "button", className: "primary-button", onClick: () => void handleAddRow(), children: "+ Agregar Fila" })) : null, canWriteLeads && selectedLeads.size > 0 ? (_jsxs("button", { type: "button", className: "danger-button", onClick: () => void handleBulkDelete(), children: ["Borrar (", selectedLeads.size, ")"] })) : null, _jsx("button", { type: "button", className: "secondary-button", onClick: () => void loadBoard(), children: "Refrescar" })] }), _jsxs("div", { className: "matters-filters leads-search-filters matters-active-search-filters", children: [_jsxs("label", { className: "form-field matters-search-field", children: [_jsx("span", { children: "Buscar por palabra" }), _jsx("input", { type: "text", value: searchTerm, onChange: (event) => setSearchTerm(event.target.value), placeholder: "Cotizacion, asunto, nota, canal..." })] }), _jsxs("label", { className: "form-field matters-search-field", children: [_jsx("span", { children: "Buscador por cliente" }), _jsx("input", { type: "text", value: clientSearch, onChange: (event) => setClientSearch(event.target.value), placeholder: "Buscar palabra del cliente..." })] })] })] })] }), _jsxs("section", { className: "panel", children: [_jsxs("div", { className: "panel-header", children: [_jsx("h2", { children: "1. Leads Activos" }), _jsxs("span", { children: [filteredActiveItems.length, " registros"] })] }), _jsx("div", { className: "lead-table-shell", children: _jsx("div", { className: "lead-table-wrapper", children: _jsxs("table", { className: "lead-table lead-table-active", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { className: "lead-table-checkbox", children: _jsx("input", { type: "checkbox", disabled: !canWriteLeads, checked: filteredActiveItems.length > 0 && filteredActiveItems.every((item) => selectedLeads.has(item.id)), onChange: (event) => {
                                                    ...
                                                    return (_jsxs("tr", { ref: (node) => {
                                                            ...
                                                            selectedLeads.has(item.id) ? "lead-row-selected" : ""
                                                        ].join(" ").trim(), title: rowState.title, children: [_jsx("td", { className: "lead-table-checkbox", children: _jsx("input", { type: "checkbox", disabled: !canWriteLeads, checked: selectedLeads.has(item.id), onChange: (event) => {
                                                                        if (!canWriteLeads) {
                                                                            return;
                                                                        }
                                                                    ...
                                                                    } }) }), _jsx("td", { children: _jsxs("select", { className: "lead-cell-input", value: item.commissionAssignee ?? "", disabled: !canWriteLeads, onChange: (event) => {
                                                                        ...
                                                                        if (updated)
                                                                            void persistLead(updated);
                                                                    }, children: [_jsx("option", { value: "", children: "Seleccionar" }), commissionOptions.map((shortName) => (_jsx("option", { value: shortName, children: shortName }, shortName)))] }) }), _jsxs("td", { children: [_jsx("input", { className: `lead-cell-input ${item.quoteNumber ? "is-readonly" : ""}`, value: item.clientName, readOnly: !canWriteLeads || Boolean(item.quoteNumber), list: `lead-clients-${item.id}`, onChange: (event) => handleLeadFieldChange(item.id, "clientName", event.target.value), onBlur: () => handleLeadBlur(item.id), title: item.quoteNumber ? "Campo bloqueado por cotizacion vinculada." : "Escribe o elige un cliente." }), _jsx("datalist", { id: `lead-clients-${item.id}`, children: uniqueClients.map((clientName) => (_jsx("option", { value: clientName }, clientName))) })] }), _jsx("td", { children: _jsx("input", { className: `lead-cell-input ${item.quoteNumber ? "is-readonly" : ""}`, value: item.prospectName ?? "", readOnly: !canWriteLeads || Boolean(item.quoteNumber), onChange: (event) => handleLeadFieldChange(item.id, "prospectName", event.target.value), onBlur: () => handleLeadBlur(item.id) }) }), _jsx("td", { children: _jsxs("select", { className: "lead-cell-input", value: item.quoteNumber ?? "", disabled: !canWriteLeads, onChange: (event) => handleLeadFieldChange(item.id, "quoteNumber", event.target.value), children: [_jsx("option", { value: "", children: "Manual (Sin cot.)" }), quotes
                                                                            .filter((quote) => !normalizeText(item.clientName) || normalizeText(quote.clientName) === normalizeText(item.clientName))
                                                                            .map((quote) => (_jsxs("option", { value: quote.quoteNumber, children: [quote.quoteNumber, " - ", quote.subject] }, quote.id)))] }) }), _jsx("td", { children: _jsx("span", { className: `lead-type-pill ${linkedQuote?.quoteType === "RETAINER" ? "is-retainer" : ""}`, children: getQuoteTypeLabel(linkedQuote) }) }), _jsx("td", { children: _jsx("input", { className: `lead-cell-input ${item.quoteNumber ? "is-readonly" : ""}`, value: item.subject, readOnly: !canWriteLeads || Boolean(item.quoteNumber), onChange: (event) => handleLeadFieldChange(item.id, "subject", event.target.value), onBlur: () => handleLeadBlur(item.id) }) }), _jsx("td", { children: _jsxs("div", { className: "lead-currency-input", children: [_jsx("span", { "aria-hidden": "true", children: "$" }), _jsx("input", { className: `lead-cell-input lead-cell-input-number ${item.quoteNumber ? "is-readonly" : ""}`, type: "number", min: "0", step: "0.01", value: Number(item.amountMxn || 0), readOnly: !canWriteLeads || Boolean(item.quoteNumber), onChange: (event) => handleLeadFieldChange(item.id, "amountMxn", event.target.value), onBlur: () => handleLeadBlur(item.id) })] }) }), _jsx("td", { children: _jsx("select", { className: "lead-cell-input", value: item.communicationChannel, disabled: !canWriteLeads, onChange: (event) => {
                                                                        const updated = updateActiveLeadLocal(item.id, (lead) => ({
                                                                            ...lead,
                                                                        ...
                                                                        if (updated)
                                                                            void persistLead(updated);
                                                                    }, children: CHANNEL_OPTIONS.map((channel) => (_jsx("option", { value: channel.value, children: channel.label }, channel.value))) }) }), _jsx("td", { children: _jsx("input", { className: "lead-cell-input", value: item.lastInteractionLabel ?? "", readOnly: !canWriteLeads, onChange: (event) => handleLeadFieldChange(item.id, "lastInteractionLabel", event.target.value), onBlur: () => handleLeadBlur(item.id) }) }), _jsx("td", { children: _jsx("input", { className: "lead-cell-input", type: "date", value: toDateInput(item.lastInteraction), readOnly: !canWriteLeads, onChange: (event) => handleLeadFieldChange(item.id, "lastInteraction", event.target.value), onBlur: () => handleLeadBlur(item.id) }) }), _jsx("td", { children: _jsx("input", { className: "lead-cell-input", value: item.nextInteractionLabel ?? "", readOnly: !canWriteLeads, onChange: (event) => handleLeadFieldChange(item.id, "nextInteractionLabel", event.target.value), onBlur: () => handleLeadBlur(item.id) }) }), _jsx("td", { children: _jsx("input", { className: "lead-cell-input", type: "date", value: toDateInput(item.nextInteraction), readOnly: !canWriteLeads, onChange: (event) => handleLeadFieldChange(item.id, "nextInteraction", event.target.value), onBlur: () => handleLeadBlur(item.id) }) }), _jsx("td", { children: _jsx("input", { className: "lead-cell-input", value: item.notes ?? "", readOnly: !canWriteLeads, onChange: (event) => handleLeadFieldChange(item.id, "notes", event.target.value), onBlur: () => handleLeadBlur(item.id) }) }), _jsx("td", { children: _jsxs("div", { className: "lead-action-stack", children: [_jsx("button", { type: "button", className: "primary-button lead-action-button", disabled: !canWriteLeads || Boolean(item.sentToClientAt), onClick: () => void handleMarkSentToClient(item.id), children: item.sentToClientAt ? "Ya enviada" : "Enviada a cliente" }), _jsx("button", { type: "button", className: "secondary-button lead-action-button", disabled: !canWriteLeads, onClick: () => void handleSendToMatters(item.id), children: "Enviar a asuntos activos" })] }) }), _jsx("td", { children: _jsx("button", { type: "button", className: "danger-button lead-delete-button", disabled: !canWriteLeads, onClick: () => void handleDelete(item.id), children: "Borrar" }) })] }, item.id));
