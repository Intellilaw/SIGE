...
export function CommissionsPage() {
    ...
    const availableCommissionSections = useMemo(() => isLegalFlow ? [...LEGALFLOW_COMMISSION_SECTIONS] : [...COMMISSION_SECTIONS], [isLegalFlow]);
