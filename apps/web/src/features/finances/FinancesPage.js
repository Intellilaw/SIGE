...
const FINANCE_PERIOD_YEARS = [2024, 2025, 2026, 2027, 2028, 2029, 2030];
const FINANCE_PERIOD_OPTIONS = FINANCE_PERIOD_YEARS.flatMap((year) => Array.from({ length: 12 }, (_, index) => {
    const month = index + 1;
    return {
...
function getFinancePeriodParts(record) {
    return {
        year: record.periodYear ?? record.year,
        month: record.periodMonth ?? record.month
    };
}
function getFinancePeriodValue(record) {
    const { year, month } = getFinancePeriodParts(record);
    return `${year}-${String(month).padStart(2, "0")}`;
}
function getFinancePeriodLabel(record) {
    const { year, month } = getFinancePeriodParts(record);
    return `${getMonthName(month)} ${year}`;
}
function parseFinancePeriodValue(value) {
...
export function FinancesPage() {
    ...
    async function loadActiveMattersView() {
        ...
        try {
            const [matters, nextClients, nextContracts, periodLock] = await Promise.all([
                ...
                apiGet(`/commissions/period-lock?year=${currentYear}&month=${currentMonth}`)
            ]);
            setClients(nextClients);
            setCommissionPeriodLocked(periodLock.locked);
            setCommissionPeriodLockCount(periodLock.confirmedByEmrtCount);
    ...
    function evaluateMonthlyRecord(record) {
        ...
        if (stats.futurePaymentsMxn < 0) {
            reasons.push("Atencion: honorarios pagados en meses anteriores + honorarios pagaderos este mes exceden Total asunto. Corrige el desglose.");
            missingItems.push("Desglose excede Total asunto");
        }
        else if (isFeeBreakdownInvalid) {
            reasons.push(`Atencion: Total asunto no coincide con honorarios pagados en meses anteriores + honorarios pagaderos este mes + honorarios pagaderos en meses posteriores. Diferencia: ${formatCurrency(stats.feeBreakdownDifferenceMxn)}.`);
    ...
    function getCollectionProbabilityValue(record) {
    ...
    function setCollectionProbability(record, probability) {
        const patch = {
    ...
    function renderMonthlyTable() {
        ...
        const renderMonthlyHeader = () => (_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { className: "finance-sticky-select", children: _jsx("input", { type: "checkbox", checked: allVisibleSelected, onChange: toggleAllRecords }) }), _jsx("th", { className: "finance-row-index finance-sticky-row-number", children: "No." }), _jsx("th", { className: "finance-sticky-client-number", children: "No. Cliente" }), _jsx("th", { className: "finance-sticky-client", children: "Cliente" }), _jsx("th", { children: "No. Cotizacion" }), _jsx("th", { children: "Tipo" }), _jsx("th", { children: "Periodo" }), _jsx("th", { children: "Asunto" }), _jsx("th", { children: "Equipo Responsable" }), _jsx("th", { children: "Conceptos trabajando" }), _jsx("th", { children: "Total Asunto" }), _jsx("th", { children: "Honorarios pagados en meses anteriores" }), _jsx("th", { children: "Honorarios pagaderos este mes" }), _jsx("th", { children: "Honorarios pagaderos en meses posteriores" }), _jsx("th", { children: "Fecha de pr\u00F3ximo pago" }), _jsx("th", { children: "Detalle Fecha" }), _jsx("th", { children: "\u00bfEn mora?" }), _jsx("th", { children: "Mensaje para clientes de servicios en curso" }), _jsx("th", { children: "Mensaje para clientes de servicios concluidos" }), _jsx("th", { children: "Pagado este mes" }), _jsx("th", { children: "Fecha Pago Real" }), _jsx("th", { children: "M\u00E9todo de pago" }), _jsx("th", { children: "Recibido" }), _jsx("th", { children: "Adeudado hoy" }), _jsx("th", { children: "Adeudo total neto" }), _jsx("th", { children: "Probabilidad de cobro este mes" }), _jsx("th", { children: "Honorarios netos cobrados este mes" }), _jsx("th", { children: "Comision cliente 20%" }), _jsx("th", { children: "Para quien" }), _jsx("th", { children: "Comision cierre 10%" }), _jsx("th", { children: "Para quien" }), _jsx("th", { children: "Ingresos menos 20% y 10%" }), _jsx("th", { children: "% Litigio" }), _jsx("th", { children: "% Corp-Lab" }), _jsx("th", { children: "% Convenios" }), _jsx("th", { children: "% Der Fin" }), _jsx("th", { children: "% Compl. Fis." }), _jsx("th", { children: "SUM %" }), _jsx("th", { children: "COM. EJEC. LITIGIO (LIDER 8%)" }), _jsx("th", { children: "COM. EJEC. LITIGIO (COLAB 1%)" }), _jsx("th", { children: "COM. EJEC. CORP-LAB (LIDER 8%)" }), _jsx("th", { children: "COM. EJEC. CORP-LAB (COLAB 1%)" }), _jsx("th", { children: "COM. EJEC. CONVENIOS (LIDER 8%)" }), _jsx("th", { children: "COM. EJEC. CONVENIOS (COLAB 1%)" }), _jsx("th", { children: "COM. EJEC. DER FIN (LIDER 10%)" }), _jsx("th", { children: "COM. EJEC. DER FIN (COLAB 1%)" }), _jsx("th", { children: "COM. EJEC. COMPL FIS (LIDER 8%)" }), _jsx("th", { children: "COM. EJEC. COMPL FIS (COLAB 1%)" }), _jsx("th", { children: "Com. Com. Cliente (1% Neto)" }), _jsx("th", { children: "Com. Finanzas (1% Neto)" }), _jsx("th", { children: "Com. Ventas (1% primer pago)" }), _jsx("th", { children: "Utilidad neta" }), _jsx("th", { children: "Hito conclusion" }), _jsx("th", { children: "\u00bfConcluy\u00f3?" }), _jsx("th", { children: "Comentarios" }), _jsx("th", { children: "Faltantes" }), _jsx("th", { children: "Accion" })] }) }));
        ...
        return (_jsx("fieldset", { className: "finance-readonly-fieldset", disabled: !canWriteFinances || commissionPeriodLocked, children: _jsxs("div", { className: "finance-table-shell finance-table-shell-sticky", children: [_jsx("div", { className: "finance-table-x-nav", onScroll: handleFinanceTableScroll, "aria-label": "Desplazamiento horizontal de la tabla mensual", children: _jsx("div", { className: "finance-table-x-nav-spacer finance-table-monthly-x-nav-spacer" }) }), _jsx("div", { className: "finance-table-scroll", onScroll: handleFinanceTableScroll, children: _jsxs("table", { className: "finance-table finance-table-monthly", children: [renderMonthlyColGroup(), renderMonthlyHeader(), _jsxs("tbody", { children: [filteredRecords.map((record, index) => {
                                            ...
                                            const hasFeeBreakdownError = stats.futurePaymentsMxn < 0 || hasCurrencyDifference(stats.feeBreakdownDifferenceMxn);
                                            ...
                                            return (_jsxs("tr", { className: rowClassName, title: reason, children: [_jsx("td", { className: "finance-cell-checkbox finance-sticky-select", children: _jsx("input", { type: "checkbox", checked: isSelected, onChange: () => toggleRecordSelection(record.id) }) }), _jsx("td", { className: "finance-row-index finance-sticky-row-number", children: index + 1 }), _jsx("td", { className: "finance-sticky-client-number", children: _jsx("input", { className: "finance-input finance-input-readonly", value: effectiveClientNumber, readOnly: true }) }), _jsx("td", { className: "finance-sticky-client", children: _jsx("input", { className: "finance-input finance-input-readonly", value: record.clientName, readOnly: true }) }), _jsx("td", { children: _jsx("input", { className: "finance-input finance-input-readonly", value: record.quoteNumber ?? "", readOnly: true }) }), _jsx("td", { children: _jsx("span", { className: `finance-type-pill ${record.matterType === "RETAINER" ? "is-retainer" : ""}`, children: getMatterTypeLabel(record.matterType) }) }), _jsx("td", { children: record.matterType === "RETAINER" ? (_jsx("select", { className: "finance-input", value: getFinancePeriodValue(record), onChange: (event) => {
                                                                const patch = parseFinancePeriodValue(event.target.value);
                                                                updateRecordLocal(record.id, patch);
                                                                void persistRecordPatch(record.id, patch);
                                                            }, children: FINANCE_PERIOD_OPTIONS.map((option) => (_jsx("option", { value: option.value, children: option.label }, option.value))) })) : (_jsx("input", { className: "finance-input finance-input-readonly", value: "-", readOnly: true })) }), _jsx("td", { children: _jsx("input", { className: "finance-input finance-input-readonly", value: record.subject, readOnly: true }) }), _jsx("td", { children: record.matterType === "RETAINER" ? (_jsxs("select", { className: "finance-input", value: record.responsibleTeam ?? "", onChange: (event) => {
                                                            ...
                                                            }, children: [_jsx("option", { value: "", children: "Seleccionar..." }), TEAM_OPTIONS.filter((option) => ["LITIGATION", "CORPORATE_LABOR", "SETTLEMENTS", "FINANCIAL_LAW", "TAX_COMPLIANCE"].includes(option.key)).map((option) => (_jsx("option", { value: option.key, children: option.label }, option.key)))] })) : (_jsx("input", { className: "finance-input finance-input-readonly", value: TEAM_OPTIONS.find((option) => option.key === record.responsibleTeam)?.label ?? "", readOnly: true })) }), _jsx("td", { children: record.matterType === "RETAINER" ? (_jsx("input", { className: "finance-input finance-input-readonly", disabled: true, readOnly: true, value: "" })) : (_jsx("input", { className: "finance-input", value: record.workingConcepts ?? "", onChange: (event) => updateRecordLocal(record.id, { workingConcepts: event.target.value }), onBlur: (event) => void persistRecordPatch(record.id, { workingConcepts: event.target.value }) })) }), _jsx("td", { children: _jsx(CurrencyInput, { value: record.totalMatterMxn, readOnly: true }) }), _jsx("td", { children: _jsx(CurrencyInput, { value: record.previousPaymentsMxn, onValueChange: (previousPaymentsMxn) => updateRecordLocal(record.id, { previousPaymentsMxn }), onValueCommit: (previousPaymentsMxn) => void persistRecordPatch(record.id, { previousPaymentsMxn }) }) }), _jsx("td", { children: _jsx(CurrencyInput, { value: record.conceptFeesMxn, onValueChange: (conceptFeesMxn) => updateRecordLocal(record.id, { conceptFeesMxn }), onValueCommit: (conceptFeesMxn) => void persistRecordPatch(record.id, { conceptFeesMxn }) }) }), _jsx("td", { title: hasFeeBreakdownError ? feeBreakdownTooltip : undefined, children: _jsxs("div", { className: "finance-validation-cell", children: [_jsx(CurrencyInput, { className: hasFeeBreakdownError ? "finance-cell-negative" : "", value: stats.futurePaymentsMxn, readOnly: true }), hasFeeBreakdownError ? (_jsx("div", { className: "finance-inline-error", children: feeBreakdownMessage })) : null] }) }), _jsx("td", { children: _jsx("input", { className: "finance-input", type: "date", value: toDateInput(record.nextPaymentDate), onChange: (event) => updateRecordLocal(record.id, { nextPaymentDate: event.target.value || null }), onBlur: (event) => void persistRecordPatch(record.id, { nextPaymentDate: event.target.value || null }) }) }), _jsx("td", { children: _jsx("input", { className: "finance-input", value: record.nextPaymentNotes ?? "", onChange: (event) => updateRecordLocal(record.id, { nextPaymentNotes: event.target.value }), onBlur: (event) => void persistRecordPatch(record.id, { nextPaymentNotes: event.target.value }) }) }), _jsx("td", { children: _jsx("select", { className: "finance-input", value: record.delinquencyStatus ?? "CURRENT", onChange: (event) => {
    ...
    function renderActiveMattersTable(items, variant) {
        ...
        const renderActiveHeader = () => (_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "No. Cliente" }), _jsx("th", { children: "Cliente" }), _jsx("th", { children: "No. Cotizacion" }), _jsx("th", { children: "Tipo" }), _jsx("th", { children: "Asunto" }), _jsx("th", { children: "Honorarios Totales" }), _jsx("th", { children: "Comision cierre" }), _jsx("th", { children: "Equipo Responsable" }), _jsx("th", { children: "Generar contrato" }), _jsx("th", { children: "Estatus del contrato de PSP" }), _jsx("th", { children: "Fecha de pr\u00F3ximo pago" }), _jsx("th", { children: "Destino (Finanzas)" }), _jsx("th", { children: "Accion" })] }) }));
        return (_jsx("fieldset", { className: "finance-readonly-fieldset", disabled: !canWriteFinances || commissionPeriodLocked, children: _jsx("div", { className: "finance-active-table-shell", children: _jsxs("table", { className: "finance-active-table", children: [renderActiveColGroup(), renderActiveHeader(), _jsxs("tbody", { children: [items.map((matter) => {
