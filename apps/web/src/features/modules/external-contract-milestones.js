...
function baseExternalContractMilestone(contract, dueDate, title, kind, description) {
    return {
...
export function mergeExternalContractMilestones(milestones) {
...
export function getExternalContractMilestones(contract) {
    const milestones = [];
...
export function getAllExternalContractMilestones(contracts) {
    return contracts.flatMap((contract) => getExternalContractMilestones(contract));
}
export function externalContractMilestoneKindLabel(kind) {
    const labels = {
        renewal: "Renovaci\u00f3n",
