...
export function UsersPage() {
    ...
    const teamOptionsForUserForm = useMemo(() => teams.filter((team) => team.isActive || team.label === form.legacyTeam), [form.legacyTeam, teams]);
    useEffect(() => {
        ...
        setForm((current) => (current.legacyTeam === form.legacyTeam
            ? { ...current, legacyTeam: "" }
            : current));
