...
export function UsersPage() {
    ...
    async function handleDeleteTeam(target) {
        setFlash(null);
        const memberWarning = target.memberCount > 0
