...
import { buildTaskModuleDescriptors } from "./task-module-descriptors";
function getErrorMessage(error) {
    return error instanceof Error ? error.message : "No se pudieron cargar los equipos de tareas.";
}
export function TasksPage() {
    ...
    const visibleModules = useMemo(() => buildTaskModuleDescriptors(taskModules), [taskModules]);
